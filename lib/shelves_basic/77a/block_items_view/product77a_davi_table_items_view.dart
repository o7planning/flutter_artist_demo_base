...
class Product77aDaviTableItemsView extends BlockItemsView<Product77aBlock> {
  const Product77aDaviTableItemsView({required super.block, super.key});
  ...
  void _onSelectProduct(ProductInfo product) {
    block.refreshItemAndSetAsCurrent(item: product);
  }
}
