...
class Country48aBlock
    extends
        ...
        > {
  static const String blkName = "country48a-block";
  ...
  @override
  bool isItemDeletionAllowed({required CountryInfo item}) {
    return false;
  }
  ...
  Future<ApiResult<PageData<CountryInfo>?>> performQuery({
    ...
    return await countryRestProvider.query(pageable: pageable);
  }
